...
def init_random_seed(seed=None, device='cuda'):
    ...
    and then broadcast to all_file processes to prevent some potential bugs.
    Args:
    ...
    # Make sure all_file ranks share the same random seed to prevent
