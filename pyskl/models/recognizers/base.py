    ...
    def _parse_losses(self, losses):
        ...
        Returns:
            tuple[Tensor, dict]: (loss, log_vars), loss is the loss tensor
                which may be a weighted sum of all_file losses, log_vars contains
                all_file the variables to be sent to the logger.
        """
    ...
    def train_step(self, data_batch, optimizer, **kwargs):
        ...
        Returns:
            dict: It should contain at least 3 keys: ``loss``, ``log_vars``,
                ...
                ``log_vars`` contains all_file the variables to be sent to the
                logger.
